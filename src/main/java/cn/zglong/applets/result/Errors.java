 ...
 */
public enum  Errors {
    E900001("900001", "未登录或会话已过期"),
    E900002("900002", "无效的会话或已过期"),
    E900003("900003", "用户名或密码错误"),
    E900004("900004", "验证码输入错误"),
    E900005("900005", "该用户不存在"),
    E900006("900006", "该用户已冻结，请联系管理员"),
    E900400("900400", "错误的请求"),
    E900401("900401", "未经授权的请求"),
    E900403("900403", "请求被拒绝"),
    E900404("900404", "请求的资源不存在"),
    E900500("900500", "服务器发生错误"),
    E999999("999999", "系统错误"),
